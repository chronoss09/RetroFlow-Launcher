...
function Category_Minus(tmpCat)
  ...
  --tmpCat = showCat - 1
    ...
    GetNameSelected()
--%%if true==true then
    if (tmpCat == 0) or (tmpCat == 2) then	 --%% billabongbruno
	return Category_Minus(tmpCat-1)		 --%% billabongbruno
    else					 --%% billabongbruno
	return tmpCat
    end
end
...
--%%if true==true then
    if (tmpCat == 0) or (tmpCat == 2) then	 --%% billabongbruno
	return Category_Plus(tmpCat+1)		 --%% billabongbruno
    else					 --%% billabongbruno
	return tmpCat
    end
end
